...
public class Soldier6xSt2 : MonoBehaviour
{
    ...
    void CreateSoldier(int Numb) // Soldier Creater
    {
        ...
        {
            asd += 0.2f;
            GameObject SoldierClones = Instantiate(SoldierOriginals, new Vector3(3f * asd, 0.57f, 52f), SoldierOriginals.transform.rotation);
        }
