...
public class Soldier2xSt3 : MonoBehaviour
{
    ...
    void CreateSoldier(int Numb) // Soldier Creater
    {
        ...
        {
            asd += 0.2f;
            GameObject SoldierClone = Instantiate(SoldierOriginal, new Vector3(2.5f * asd, 0.40f, 97f), SoldierOriginal.transform.rotation);
        }
